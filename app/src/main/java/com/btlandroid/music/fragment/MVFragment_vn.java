...
public class MVFragment_vn extends Fragment {
    View view;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.fragment_mv_vn, container, false);

        recyclerViewMV = view.findViewById(R.id.rvVnMV);
        GetData();
    ...
    private void GetData() {
        ...
        Call<List<Mv>> callback = dataService.getVnMV();
