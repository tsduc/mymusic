...
public class MVFragment_asia extends Fragment {
    View view;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.fragment_mv_asia, container, false);

        recyclerViewMV = view.findViewById(R.id.rvAsiaMV);
        GetData();
    ...
    private void GetData() {
        ...
        Call<List<Mv>> callback = dataService.getAsiaMV();
