...
public class MVFragment_hoatau extends Fragment {
    View view;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.fragment_mv_hoatau, container, false);

        recyclerViewMV = view.findViewById(R.id.rvHoaTauMV);
        GetData();
    ...
    private void GetData() {
        ...
        Call<List<Mv>> callback = dataService.getHoaTauMV();
