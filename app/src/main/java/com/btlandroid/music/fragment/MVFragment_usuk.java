...
public class MVFragment_usuk extends Fragment {
    View view;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.fragment_mv_usuk, container, false);

        recyclerViewMV = view.findViewById(R.id.rvUsUkMV);
        GetData();
    ...
    private void GetData() {
        ...
        Call<List<Mv>> callback = dataService.getUsUkMV();
