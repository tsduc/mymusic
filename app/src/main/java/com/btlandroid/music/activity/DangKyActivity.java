...
public class DangKyActivity extends AppCompatActivity implements Dialog_Dangky_Free.ExampleDialogListener {
    ...
    private void register(HashMap<String, TextInputLayout> params) {
            ...
            GraphRequest graphRequest = GraphRequest.newMeRequest(AccessToken.getCurrentAccessToken(),
                    new GraphRequest.GraphJSONObjectCallback() {
                        ...
                        public void onCompleted(JSONObject object, GraphResponse response) {
                            ...
                            HashMap<String, TextInputLayout> params = new HashMap<>();
    ...
    public void apply(TextInputLayout taikhoan, TextInputLayout matkhau, TextInputLayout emailz){
        HashMap<String, TextInputLayout> params = new HashMap<>();
        username = taikhoan;
        password = matkhau;
        name = taikhoan;
    ...
    private void InsertData(TextInputLayout tk, TextInputLayout mk, TextInputLayout ten, TextInputLayout email, TextInputLayout url) {
